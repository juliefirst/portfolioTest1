...
function call() {
  ...
  var servers1 = null;
  var servers2 = new Object();
  pc1Local = new RTCPeerConnection(servers1);
  pc1Remote = new RTCPeerConnection(servers1);
  pc1Remote.onaddstream = gotRemoteStream1;
  pc1Local.onicecandidate = iceCallback1Local;
  pc1Remote.onicecandidate = iceCallback1Remote;
  trace('pc1: created local and remote peer connection objects');

  pc2Local = new RTCPeerConnection(servers2);
  pc2Remote = new RTCPeerConnection(servers2);
